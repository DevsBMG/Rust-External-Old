...
namespace Offsets
{
	namespace Vars
	{
		offset(ConVar_Graphics_c, 53974992);
		offset(ConVar_Admin_c, 53683072);
		offset(Baseplayer_c, 53727264);
		offset(Skinnable_c, 53851936);
		offset(ConVar_Client_c, 53796216);
		offset(ConVar_Console_c, 53811384);
		offset(MainCamera_c, 54172280);
		offset(BaseEntity_c, 53982080);// System_Collections_Generic_List_BaseGameMode__c*
		offset(BaseGameMode_c, 53723968);
		offset(LocalPlayer_c, 54160448);
		offset(FlashBangOverlay_c, 53940816);
		offset(TodSky_c, 53923192);// "Signature": "TOD_Sky_c*"
		offset(ConsoleSystem_c, 53813144);
		//offset(LaserBeam_c, 54133136);
		offset(StorageContainer_c, 53902360);
		offset(OutlineManager_c, 53695456);
		offset(WaterSystem_c, 54034728);
		offset(Buttons_c, 53755400);
		offset(consoleSystem_index_c, 54166328);
		offset(BuildingBlock_c, 53752320);
		offset(effectNetwork_c, 53908336);
	}
